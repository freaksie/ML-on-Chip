// ==============================================================
// File generated on Mon Oct 23 14:47:49 PDT 2023
...
ap_fixed<16, 6, (ap_q_mode) 5, (ap_o_mode)3, 0> input_2[2],
ap_fixed<16, 6, (ap_q_mode) 5, (ap_o_mode)3, 0> layer7_out[1]);
...
ap_fixed<16, 6, (ap_q_mode) 5, (ap_o_mode)3, 0> layer7_out[1])
{
	...
	else
	{
		...
		sc_bv<32>* input_2_V_tvin_wrapc_buffer = new sc_bv<32>[1];
