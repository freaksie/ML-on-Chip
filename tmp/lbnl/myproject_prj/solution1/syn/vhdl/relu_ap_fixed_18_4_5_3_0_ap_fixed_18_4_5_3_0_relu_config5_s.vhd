...
entity relu_ap_fixed_18_4_5_3_0_ap_fixed_18_4_5_3_0_relu_config5_s is
port (
...
architecture behav of relu_ap_fixed_18_4_5_3_0_ap_fixed_18_4_5_3_0_relu_config5_s is 
...
begin
    ...
    res_1_V_write_assign_fu_82_p3 <= 
        tmp_5_fu_78_p1 when (tmp_1_1_fu_72_p2(0) = '1') else 
        ap_const_lv17_0;
    ...
    res_2_V_write_assign_fu_104_p3 <= 
        tmp_6_fu_100_p1 when (tmp_1_2_fu_94_p2(0) = '1') else 
        ap_const_lv17_0;
    ...
    res_3_V_write_assign_fu_126_p3 <= 
        tmp_7_fu_122_p1 when (tmp_1_3_fu_116_p2(0) = '1') else 
        ap_const_lv17_0;
    ...
    tmp_5_fu_78_p1 <= data_1_V_read(17 - 1 downto 0);
    tmp_6_fu_100_p1 <= data_2_V_read(17 - 1 downto 0);
    tmp_7_fu_122_p1 <= data_3_V_read(17 - 1 downto 0);
